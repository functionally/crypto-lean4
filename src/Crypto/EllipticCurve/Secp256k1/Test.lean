...
#lspec test "Alice's public key matches expectation." (
  alice.pub =
...
#lspec test "Bob's public key matches expectation." (
  bob.pub =
    EllipticCurve.Point.mk
...
#lspec test "Alice and Bob have a shared secret." (
  aliceBob = bobAlice
)

#lspec test "Alice's and Bob's shared sectret matches expectation." (
  aliceBob =
    EllipticCurve.Point.mk
